...
from devkit_cli.ui import select_agent, show_result, show_version, show_error, show_main_menu, prompt_project_path, console
...
def init(
    ...
    try:
        ...
        console.print(f"\n[dim]Installing templates to {project_path}...[/dim]")
        ...
        if result.success:
            ...
            console.print(f"  2. Use the installed templates in your coding agent")
            console.print()
