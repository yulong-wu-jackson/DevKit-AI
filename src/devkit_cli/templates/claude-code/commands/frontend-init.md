...
# Frontend Techstack Initialization
...
you should make sure to use the latest stable version of every techstack (by cross verifying using bash command and using webfetch and wb search functionality)
